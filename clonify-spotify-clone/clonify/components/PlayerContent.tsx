...
const PlayerContent: React.FC<PlayerContentProps> = ({song, songUrl}) => {
    ...
    // the reason why key is set to songUrl is so the below hook can function accordingly
    // the component gets reloaded and the hook is executed again with the new songUrl
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 h-full">
        ...
        <div className="hidden h-full md:flex justify-center items-center w-full max-w-[722px] gap-x-6">
            ...
            <AiFillStepForward size={30} onClick={onPlayNext} className="text-neutral cursor-pointer hover:text-white transition"/>
        </div>
